            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                ...
                <div class="side-menu animate-dropdown outer-bottom-xs">
                    ...
                    <nav class="yamm megamenu-horizontal">
                        <ul class="nav">
                            <li class="dropdown menu-item"> <a href="{{ route('category') }}" class="dropdown-toggle" data-toggle="dropdown"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-md-3">
                                                <ul class="links list-unstyled">
                                                    ...
                                                    <li><a href="{{ route('category') }}">Night Suits</a></li>
                                                </ul>
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-12 col-md-3">
                                                <ul class="links list-unstyled">
                                                    ...
                                                    <li><a href="{{ route('category') }}">Wipes</a></li>
                                                </ul>
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-12 col-md-3">
                                                <ul class="links list-unstyled">
                                                    ...
                                                    <li><a href="{{ route('category') }}">Toys</a></li>
                                                </ul>
                                            </div>
                                            <!-- /.col -->
                                        </div>
                            ...
                            <li class="dropdown menu-item"> <a href="{{ route('category') }}" class="dropdown-toggle"
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ route('product-details') }}"> <img
                                                                    src="asset/frontend/assets/images/products/p15.jpg" alt="">
                                                            </a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ route('product-details') }}"> <img
                                                                    src="asset/frontend/assets/images/products/p7.jpg" alt=""> </a>
                                                        </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ route('product-details') }}"> <img
                                                                    src="asset/frontend/assets/images/products/p6.jpg" alt="image">
                                                            </a> </div>
                                                        <!-- /.image -->
                                        ...
                                        <div class="product-micro">
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a href="{{ route('product-details') }}"> <img
                                                                    src="asset/frontend/assets/images/products/p5.jpg" alt="images">
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="{{ route('product-details') }}">Apple Iphone
                                                            5s 32GB</a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                                    <div class="product-price"> <span class="price">
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                ...
                                                <div class="product-info text-left">
                                                    <h3 class="name"><a href="{{ route('product-details') }}">Samsung
                                                            Galaxy S4</a></h3>
                                                    <div class="rating rateit-small"></div>
                                                    <div class="description"></div>
                                                    <div class="product-price"> <span class="price">
                ...
                <div class="wide-banners outer-bottom-xs">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <img class="img-responsive"
                                        src="asset/frontend/assets/images/banners/home-banner3.jpg" alt=""> </div>
                            </div>
                            <!-- /.wide-banner -->
                        </div>
                ...
                <section class="section featured-product">
                    <div class="row">
                        <div class="col-lg-3">
                            ...
                            <ul class="sub-cat">
                                <li><a href="{{ route('category') }}">Computers</a></li>
                                <li><a href="{{ route('category') }}">Air Condtion</a></li>
                                <li><a href="{{ route('category') }}">Mobile Phones</a></li>
                                <li><a href="{{ route('category') }}">Camera</a></li>
                                <li><a href="{{ route('category') }}">Television</a></li>
                                <li><a href="{{ route('category') }}">Sound & Speakers</a></li>
                                <li><a href="{{ route('category') }}">Games & Audio Music</a></li>
                                <li><a href="{{ route('category') }}">Digital Watches</a></li>
                                <li><a href="{{ route('category') }}">Washing Machines</a></li>
                                <li><a href="{{ route('category') }}">Office Electronics</a></li>
                            </ul>
                        </div>
                        <div class="col-lg-9">
                ...
                <div class="wide-banners outer-bottom-xs">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="wide-banner cnt-strip">
                                <div class="image"> <img class="img-responsive"
                                        src="asset/frontend/assets/images/banners/home-banner4.jpg" alt=""> </div>
                        ...
                        <div class="owl-carousel blog-slider custom-carousel">
                                ...
                                <div class="blog-post">
                                    <div class="blog-post-image">
                                        <div class="image"> <a href="blog.html"><img
                                                    src="asset/frontend/assets/images/blog-post/blog_big_01.jpg" alt=""></a> </div>
                                    </div>
                                    <!-- /.blog-post-image -->
                            ...
                            <div class="item">
                                <div class="blog-post">
                                    <div class="blog-post-image">
                                        <div class="image"> <a href="blog.html"><img
                                                    src="asset/frontend/assets/images/blog-post/blog_big_02.jpg" alt=""></a> </div>
                                    </div>
                                    <!-- /.blog-post-image -->
                            ...
                            <div class="item">
                                <div class="blog-post">
                                    <div class="blog-post-image">
                                        <div class="image"> <a href="blog.html"><img
                                                    src="asset/frontend/assets/images/blog-post/blog_big_03.jpg" alt=""></a> </div>
                                    </div>
                                    <!-- /.blog-post-image -->
                        ...
                        <div class="item item-carousel">
                            <div class="products">
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a href="{{ route('product-details') }}">Floral Print Buttoned</a>
                                        </h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                                            ...
                                            <ul class="list-unstyled">
                                                ...
                                                <li class="lnk wishlist"> <a class="add-to-cart"
                                                        href="{{ route('product-details') }}" title="Wishlist"> <i
                                                            class="icon fa fa-heart"></i> </a> </li>
                                                <li class="lnk"> <a class="add-to-cart"
                                                        href="{{ route('product-details') }}" title="Compare"> <i class="fa fa-signal"
            ...
            <div class="logo-slider-inner">
                <div id="brand-slider" class="owl-carousel brand-slider custom-carousel owl-theme">
                    <div class="item m-t-15"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand1.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->

                    <div class="item m-t-10"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand2.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->

                    <div class="item"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand3.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->

                    <div class="item"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand4.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->

                    <div class="item"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand5.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->

                    <div class="item"> <a href="#" class="image"> <img
                                data-echo="asset/frontend/assets/images/brands/brand6.png" src="asset/frontend/assets/images/blank.gif" alt="">
                        </a> </div>
                    <!--/.item-->
