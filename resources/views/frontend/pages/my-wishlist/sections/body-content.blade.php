                ...
                <div class="col-md-12 my-wishlist">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td class="col-md-2 col-sm-6 col-xs-6"><img src="asset/frontend/assets/images/products/p1.jpg"
                                            alt="imga"></td>
                                ...
                                <tr>
                                    <td class="col-md-2"><img src="asset/frontend/assets/images/products/p2.jpg" alt="phoro">
                                    </td>
                                    <td class="col-md-7">
                                        <div class="product-name"><a href="#">Floral Print Buttoned</a></div>
                                        <div class="rating">
