                                ...
                                <div id="owl-single-product">
                                    <div class="single-product-gallery-item" id="slide1">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p1.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                                data-echo="asset/frontend/assets/images/products/p1.jpg" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->

                                    <div class="single-product-gallery-item" id="slide2">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p2.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                                data-echo="asset/frontend/assets/images/products/p2.jpg" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->

                                    <div class="single-product-gallery-item" id="slide3">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p3.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                                data-echo="asset/frontend/assets/images/products/p3.jpg" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->

                                    <div class="single-product-gallery-item" id="slide4">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p4.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                                data-echo="asset/frontend/assets/images/products/p4.jpg" />
                                        </a>
                                    </div><!-- /.single-product-gallery-item -->

                                    <div class="single-product-gallery-item" id="slide5">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p5.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                    ...
                                    <div class="single-product-gallery-item" id="slide6">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p6.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
                                    ...
                                    <div class="single-product-gallery-item" id="slide7">
                                        <a data-lightbox="image-1" data-title="Gallery"
                                            href="asset/frontend/assets/images/products/p7.jpg">
                                            <img class="img-responsive" alt="" src="asset/frontend/assets/images/blank.gif"
